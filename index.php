...
<div id="about">
	...
	<div>Загадка - безцінний інструмент розвитку мислення, як для дітей так і для дорослих.<br /> 
		<br />Джей Джей Абрамс - "Загадка — каталізатор уяви."<br />
		<br />Джон Фаулз - "... в будь-якій загадці прихована енергія. І той хто шукає відповідь, цією енергією живиться"<br />
		<br />Едгар Аллан По. Золотий жук - "Жоден людьський розум не в змозі вигадати таку головоломку, яку інша людина, наділена певною кмітливістю та правильно її застосовуючи, була б не в змозі розгадати."<br />
		...
		<br />
		<br />Відгадуйте та розвивайтесь разом із нами!<br /><br />
	</div>
	<div>
